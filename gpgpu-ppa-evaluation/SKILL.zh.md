...
若想了解与本 skill 相关的 Rocket Chip 背景，请阅读本目录下的 `rocket_local.md`。它说明 local perf events、HellaCache counters、trace infrastructure、named configs、TestHarness/regression/Verilator support，以及如何把 PPA evidence 绑定到 config 和 workload。
